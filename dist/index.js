...
var _sample_graph = require('./lib/sample_graph');

var _sample_graph2 = _interopRequireDefault(_sample_graph);
...
var force = _d2.default.layout.force().nodes(nodes).links(links).size([width, height]).linkDistance(150).charge(-500).on('tick', tick);
...
function restart() {
  ...
  g.append('svg:circle').attr('class', 'node').attr('r', 12).style('fill', function (d) {
    ...
    drag_line.style('display', 'none').style('marker-end', '');
    ...
    var edge = new _edge2.default(mousedown_node, mouseup_node);
    graph.addEdge(edge);
...
function updateDragLine() {
  ...
  drag_line.attr('d', 'M' + mousedown_node.x + ',' + mousedown_node.y + 'L' + _d2.default.mouse(this)[0] + ',' + _d2.default.mouse(this)[1]);
...
var Edge = function () {
  function Edge(source, target, capacity) {
...
var Graph = function () {
  ...
  _createClass(Graph, [{
    ...
    key: 'setSource',
    value: function setSource(vertex) {
...
var sample_graph = new _graph2.default();
var v0 = new _vertex2.default(0);
var v1 = new _vertex2.default(1);
var v2 = new _vertex2.default(2);
var v3 = new _vertex2.default(3);
